...
- VoIP: Fix stale or malformed inbound SIP INVITEs triggering phantom frontend call callbacks without a valid Call-ID.
...
- Misc: Use newer Python packaging logic and fix SetuptoolsDeprecationWarning
...
- Acknowledgements: [synodriver/pysilk](https://github.com/synodriver/pysilk) (better link)
